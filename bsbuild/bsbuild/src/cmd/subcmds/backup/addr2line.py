...
# TODO 1.parse call stack: 05-18 14:31:39.726  4729  4729 F DEBUG   :     #03 pc 000000000001de40  /system/lib64/libc.so (__start_thread+16)
# TODO 2.show code: sed -n '65,75p' frameworks/native/libs/cmdui/GraphicBuffer.cpp
...
class Addr2line(Command):
    ...
    def main():
        ...
        for line in stacks:
            ...
            frame, stack_addr, so_path = parse_stack(line)
